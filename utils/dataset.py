...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = cv2.imread(filename.replace('jpg', 'png'), flags=0)
...
class Augmentations:
    def __init__(self):
        ...
        self.transform = albumentations.OneOf([albumentations.ISONoise(),
                                               albumentations.GaussNoise(),
                                               albumentations.ChannelShuffle(),
                                               albumentations.ChannelDropout(),
                                               albumentations.RandomShadow(num_shadows_lower=1,
                                                                           num_shadows_upper=1)])
